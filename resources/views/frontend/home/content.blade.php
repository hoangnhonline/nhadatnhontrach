...
<section class="col-sm-8 col-xs-12 block-sitemain">
    ...
    <div class="col-sm-12 col-xs-12">
      <div class="row">
        <div class="block-title block-title-common">          
          <h3><span class="icon-tile2"><img src="{{ URL::asset('assets/images/icon-tvl.png') }}" alt="Hỗ trợ pháp lý"></span> Hỗ trợ pháp lý</h3>
        </div>
        <div class="block-contents">
  ...
  <article class="block block-fengshui clearfix">
    <div class="col-sm-12 col-xs-12">
      <div class="row">
        <div class="block-title block-title-common">
          <h3><span class="icon-tile2"><img src="{{ URL::asset('assets/images/icon-tkkt.png') }}" alt="Hỗ trợ tài chính"> Hỗ trợ tài chính</h3>
        </div>
        <div class="block-contents">
